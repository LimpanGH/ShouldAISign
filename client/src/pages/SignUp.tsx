...
import classes from '../css/SignUp.module.css'; // Importing CSS module
...
const SignUp = () => {
  ...
  return (
    <div className={classes['signup-container']}> {/* Using classes from module */}
      ...
      <form onSubmit={handleSubmit(onSubmit)} className={classes['signup-form']}>
