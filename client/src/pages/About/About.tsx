      ...
      <div className={classes['about-content']}>
        <div>
          <p className={classes['shouldaisign-text']}>
            ...
            <p>
              Jag har driv, och söker ett företag som vill förvalta det på ett
              bra sätt. Med vänlig hälsning, Linus Johannesson{' '}
            </p>
            <br />
      ...
      <div className={classes['about-content']}>
        <div>
          <p className={classes['shouldaisign-text']}>
            ...
            agreements are hard to grasp and that inspired me to develop a
            service that can help users understand what they sign. Frontend:
            Vite, React, Typescript. Backend: GraphQL, Mongoose, React,
            Typescript, Jsonwebtoken, Bcrypt, Express, OpenAI. DB: Atlas
            MongoDB. Hosted on AWS EC2 using Ngingx as webserver. Domain-name
            from GleSys.
          </p>
        </div>
      </div>
      ...
      <div className={classes['about-content']}>
        <div>
          <p className={classes['shouldaisign-text']}>
            ...
            totam quidem repellendus facilis sunt sint sequi provident quam
            ipsam praesentium illum? Ipsa, amet soluta nam laudantium, ratione
